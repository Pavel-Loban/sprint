...
describe('Test width 1440px', () => {
  ...
  it('test navigation view', () => {
    cy.get('[data-test-id=navigation-showcase]').each((ele)=>{cy.log(ele.text())}).should('be.exist').click();
    cy.get('[data-test-id=navigation-books]').each((ele)=>{cy.log(ele.text())}).should('not.be.visible');
...
describe('Test width 768px', () => {
  ...
  it('test navigation view', () => {
    cy.get('[data-test-id=button-burger]').click();
    cy.get('[data-test-id=burger-showcase]').each((ele)=>{cy.log(ele.text())}).should('be.exist').click();
    cy.get('[data-test-id=burger-books]').each((ele)=>{cy.log(ele.text())}).should('not.be.visible');
